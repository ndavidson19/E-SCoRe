    ...
    for block in blocks:
        try:
            ...
            if question_id and question:
                ...
                print(f"Incomplete data for a question block. Skipping...")
...
def main():
    parser = argparse.ArgumentParser(description="Parse SAT Questions from PDF to CSV")
    ...
    logger.info(f"Extracting text from PDF: {args.pdf_path}")
